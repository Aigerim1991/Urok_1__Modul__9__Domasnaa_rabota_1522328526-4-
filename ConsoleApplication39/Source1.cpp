...
void random_dvumer(int *p, int len, int len2)
{
	for (int i = 0; i < len; i++)
	{
		for (int j = 0; j < len2; j++)
		{
			*(p + i*len + j) = 1 + rand() % 100;
		}
	}
}
...
void  minus(int *pt, int len)
{
	...
	printf("Количество отрицательных элементов массива=%d/n", summ);
}
void  modulmen7(int *pt, int len)
{
	...
	printf("модуль которых меньше 7 = %d/n", summ);
}
...
void  Neotr(int *pt, int len)
{
	...
	printf("количество неотрицательных элементов массива %d/n", max);
}
void  posled(int *pt, int len)
{
	...
	printf("индекс последнего отрицательного элемента массива %d/n", max);
}
void  MinMax(int *pt, int len)
{
	...
	printf("сумма минимального и максимального элементов %d/n", max + min);
}
void  MinMaxProiz(int *pt, int len)
{
	...
	printf("произведение минимального и максимального элементов %d/n", max * min);
}
...
void  Gde20(int *pt, int len)
{
	...
	if (max != 0)
		printf("есть ли в массиве число 20  %d/n", max);
	else
		printf("нету");
}